    ...
    <div class="card-body">
        <form id="karierForm" action="{{ route('karier.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control tinymce-editor @error('responsibilities') is-invalid @enderror" id="responsibilities" name="responsibilities">{{ old('responsibilities') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control tinymce-editor @error('qualification') is-invalid @enderror" id="qualification" name="qualification">{{ old('qualification') }}</textarea>
                @error('qualification')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
